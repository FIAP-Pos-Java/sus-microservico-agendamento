...
* The original package name 'sus.microservico.agendamento.sus-microservico-agendamento' is invalid and this project uses 'sus.microservico.agendamento.sus_microservico_agendamento' instead.
